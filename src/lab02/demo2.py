# demo.py
# Демонстрационный скрипт для класса BusFleet (лабораторная работа №2).
# Показывает все ключевые возможности: создание, добавление, удаление,
# поиск, сортировку, индексацию, итерацию, фильтрацию.
